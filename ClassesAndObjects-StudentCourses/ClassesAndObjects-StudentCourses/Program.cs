...
namespace ClassesAndObjects_StudentCourses
{
    class Program
    {
        ...
        static void DoStudentExamples()
        {
            ...
            Student student1 = new Student("John McClary", StudenkRank.Senior);
            ...
            Student student2 = new Student("Nicole Wino", StudenkRank.Junior);
            ...
            var onlyJuniors = studentList
                .Where(x => x.StudentRank == (StudenkRank)3);
    ...
    public class Student
    {
        ...
        public double GPA
        {
            get
            {
                ...
                //    totalSum += x.GradePoint += x.Price / x.Squarefeet;
                //}
                //return totalSum / this.CourseList.Count;
            }
        }

        private StudenkRank _studentRank;

        public StudenkRank StudentRank
        {
        ...
        //STEP 2: CONSTRUCTORS!!!
        public Student(string name, StudenkRank rank)
        {
            this.Name = name;
